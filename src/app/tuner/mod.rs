...
pub fn show_controller_tuner(ui: &mut egui::Ui, controller: &mut Controller) {
    ...
    ui.horizontal(|ui| {
        ...
        ui.vertical(|ui| {
            ui.add(egui::widgets::Checkbox::new(lead_lag.is_activated(), "Lead-lag"));
            ui.horizontal(|ui| {
                ui.add_enabled(
                    *lead_lag.is_activated(),
                    egui::widgets::Label::new("Zero:")
                );
                ui.add_enabled(
                    *lead_lag.is_activated(),
        ...
        ui.vertical(|ui| {
            ui.add(egui::widgets::Checkbox::new(lag_lead.is_activated(), "Lag-lead"));
            ui.horizontal(|ui| {
                ui.add_enabled(
